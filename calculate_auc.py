...
def main():
                ...
                for PS_i in p_list:
                    for lag_i in lag_list:
                        ...
                        for cano_type in ["1", "5", "all"]:
                            ...
                            df.to_csv(f'{new_dir_path1}/auc_{mode}_{data_name}_{M}_{DS_dim}_{PS_dim}_{cano_type}_{lag_i}1.csv')
                            #print(count)
    ...
    df_ave.to_csv('auc_'+mode+'_ave1.csv')
    df_all.to_csv('auc_'+mode+'_max1.csv')
    #print("")
